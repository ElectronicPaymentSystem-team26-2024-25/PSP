...
import { PaymentMethod, Subscription } from '../model/subscription.model';
...
export class MerchantService {
  ...
  getNotSubscribedPayments(email: string): Observable<PaymentMethod[]>{
    return this.http.get<PaymentMethod[]>(environment.apiHost + 'merchant/payment/not/subscribed?businessEmail=' + email);
  }
